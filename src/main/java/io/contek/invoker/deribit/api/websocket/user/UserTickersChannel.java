...
@ThreadSafe
public final class UserTickersChannel
    extends UserWebSocketChannel<UserTickersChannel.Message, UserTickersChannel.Data> {

  UserTickersChannel(Id id, WebSocketRequestIdGenerator requestIdGenerator) {
