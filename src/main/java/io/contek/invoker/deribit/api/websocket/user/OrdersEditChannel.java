...
@ThreadSafe
public final class OrdersEditChannel
    extends UserWebSocketChannel<OrdersEditChannel.Message, OrdersEditChannel.Data> {

  OrdersEditChannel(Id id, WebSocketRequestIdGenerator requestIdGenerator) {
